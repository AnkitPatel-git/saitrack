...
@endif
      ...
      <!--  <tr> -->
      <!--</table>-->
      <table class="mytable mytable-body" style="border-bottom: 1px; margin-bottom: 10px;">
          
         @if(stripos($data->cust_name, 'hafele') !== false)
    <tr>
        <td width="50%" colspan="2">Claim Id:{{ $data->claimid }}</td>
    </tr>
@endif
        <tr>
            <td width="50%" style="border-left: 0;">Delivery Details:</td> 
            
          <td width="50%">Delivery Date & Time: {{ $data->created_at }}</td> 
        <tr> 
        <!--<tr>-->
        <!--    <td width="50%" colspan="2">Time: {{ $data->created_at }}</td> -->
        <!--<tr> -->
        <tr>
            <td width="50%"  style="border-right: 0;"> Name: {{ $data->con_client_name }}</td> 
